...
def format_sources(response):
    ...
    base = "https://github.com/run-llama/llama_index/tree/main/"
...
def sidebar():
    ...
    with st.sidebar:
        ...
        with col_gh:
            "[![Github](https://img.shields.io/badge/Github%20Repo-gray?logo=Github)](https://github.com/goldzulu/llamaindexdocschat)"
